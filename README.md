...
> **Current Version: `v2.0`** — Context Fabric: Reference Layer, @-mention, Graph RAG & World Graph
...
- **World Graph**: หน้ากราฟทั้งโลก เห็นความเชื่อมโยงของทุก entity ในแวบเดียว · ชี้โหนดไฮไลต์เพื่อนบ้าน คลิกเปิดหน้า · กรองตามที่มา (ผู้เขียน/AI)
...
- Sync เป็น **manual** by design — ผู้เขียนคุมว่าจะให้ AI เห็นอะไรเมื่อไหร่
...
L1  Reference Layer — ตาราง `references` เดียว แทน junction 20+ ตัว (มีทิศทาง + meta + createdBy)
...
| 2–3 | Dual-write junction + backfill | ✅ Done |
