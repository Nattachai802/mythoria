...
| 3 | หาพื้นของไทยด้วยฟีเจอร์จริง ไม่ใช่ character 3-gram | ตัวเลขข้างบนเป็นตัวแทน ยังไม่ใช่ MTLD/function word ที่ใช้จริง |
| 4 | ทบทวน `NOTABLE_Z = 1.0` หลังได้พื้นแล้ว | ตัวตั้งที่เป็น noise + เกณฑ์ 1.0 = ติดธงเป็นประจำโดยไม่มีอะไรเกิดขึ้นจริง |
